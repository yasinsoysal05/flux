...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => "Valido fino alle ${date}";

  static m15(message) => "Warning: ${message}";

  static m16(length) => "Abbiamo trovato \$length prodotti";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("Rimuovi da WishList"),
