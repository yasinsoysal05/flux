...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => "मान्य तिल ${date}";

  static m15(message) => "चेतावनी: ${message}";

  static m16(length) => "हमें ${length} उत्पाद मिले";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("विशलिस्ट में निकालें"),
