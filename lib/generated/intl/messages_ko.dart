...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => " ${date}까지 유효";

  static m15(message) => "경고 : ${message}";

  static m16(length) => " ${length} 개의 제품을 찾았습니다.";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("위시리스트에 제거"),
