...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => "Érvényes: ${date}";

  static m15(message) => "Figyelmeztetés: ${message}";

  static m16(length) => "Találtunk ${length} terméket";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("Eltávolítás a WishListre"),
