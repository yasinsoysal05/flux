...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m15(message) => "ئاگاداری: ${message}";

  static m16(length) => "${length} بەرهەم دۆزرایەوە";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("سڕینەوە لە لیستی دڵخوازەکاندا"),
