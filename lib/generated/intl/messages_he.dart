...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m14(date) => "תקף עד ${date}";

  static m15(message) => "אזהרה: ${message}";

  static m16(length) => "מצאנו ${length} מוצרים";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "removeToWishList" : MessageLookupByLibrary.simpleMessage("הסר לרשימת המשאלות"),
