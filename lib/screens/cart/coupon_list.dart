...
class _CouponListState extends BaseScreen<CouponList> {
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    services.getCoupons().then((coupons) {
  ...
  void _displayCoupons(BuildContext context) {
    ...
    final String searchQuery = _couponTextController.text.toLowerCase();
...
class CouponItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String count = _getCouponCount(coupon, email);
  ...
  List<Widget> _getCouponExpireDateWidget(BuildContext context, Coupon coupon) {
    final String locale = Provider.of<AppModel>(context).langCode ?? 'en';
    final DateTime now = DateTime.now();
    final bool expiringSoon = coupon.dateExpires != null &&
...
String _getCouponAmount(BuildContext context, Coupon coupon) {
  ...
  if (coupon.isFixedCartDiscount || coupon.isFixedProductDiscount) {
    final AppModel model = Provider.of<AppModel>(context);
